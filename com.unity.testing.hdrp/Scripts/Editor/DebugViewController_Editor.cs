...
public class DebugViewController_Editor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if ( ( (UnityEngine.Rendering.HighDefinition.HDRenderPipelineAsset) UnityEngine.Rendering.QualitySettings.renderPipeline) != null ) // avoid displaying the following if the assigned RP is not a HDRP
        {
