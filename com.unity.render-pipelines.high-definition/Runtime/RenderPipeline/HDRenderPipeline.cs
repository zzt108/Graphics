...
namespace UnityEngine.Rendering.HighDefinition
{
    ...
    public partial class HDRenderPipeline:RenderPipeline
    {
        ...
        internal static HDRenderPipelineAsset currentAsset
            => QualitySettings.renderPipeline as HDRenderPipelineAsset; //TODOJENNY - upgrade path? used to be GraphicsSettings.currentRenderPipeline
        ...
        ComputeShader m_ScreenSpaceReflectionsCS { get { return HDDefaultSettings.instance.renderPipelineResources.shaders.screenSpaceReflectionsCS; } }
        ...
        public HDRenderPipeline(HDRenderPipelineAsset asset)
        {
            ...
            m_ColorResolveMaterial = CoreUtils.CreateEngineMaterial(m_defaultSettings.renderPipelineResources.shaders.colorResolvePS);
            m_MotionVectorResolve = CoreUtils.CreateEngineMaterial(m_defaultSettings.renderPipelineResources.shaders.resolveMotionVecPS);
