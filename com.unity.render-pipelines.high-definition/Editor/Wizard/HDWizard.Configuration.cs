...
namespace UnityEditor.Rendering.HighDefinition
{
    ...
    partial class HDWizard
    {
        ...
        bool IsHdrpAssetUsedCorrect()
            => QualitySettings.renderPipeline is HDRenderPipelineAsset;
        ...
        void FixHdrpAssetUsed(bool fromAsync)
        {
            ...
            CreateOrLoad<HDRenderPipelineAsset>(fromAsync
                ? () => m_Fixer.Stop()
            : (Action)null,
                asset => QualitySettings.renderPipeline = asset);
        }

        bool IsHdrpAssetRuntimeResourcesCorrect()
            => IsHdrpAssetUsedCorrect()
            && HDDefaultSettings.instance? HDDefaultSettings.instance.AreResourcesCreated(): false;
        ...
        bool IsHdrpAssetEditorResourcesCorrect()
            => IsHdrpAssetUsedCorrect()
            && HDDefaultSettings.instance ? HDDefaultSettings.instance.AreEditorResourcesCreated(): false;
        ...
        void FixSRPBatcher(bool fromAsyncUnused)
        {
            ...
            var hdrpAsset = HDRenderPipeline.currentAsset; //TOTOJENNY - fix move enableSRPBatcher to DefaultSettings
            if (hdrpAsset == null)
                return;
        ...
        {
            var profileList = HDDefaultSettings.instance.renderPipelineEditorResources.defaultDiffusionProfileSettingsList;
        ...
        void FixHdrpAssetDiffusionProfile(bool fromAsyncUnused)
        {
            ...
            var hdrpAsset = HDRenderPipeline.currentAsset; //TODOJENNY - necessary?
            if (hdrpAsset == null)
                return;

            var defaultAssetList = HDDefaultSettings.instance.renderPipelineEditorResources.defaultDiffusionProfileSettingsList;
        ...
        bool IsDXRAssetCorrect()
            => HDDefaultSettings.instance != null
